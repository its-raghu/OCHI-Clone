...
function Eyes() {
  ...
  return (
    <div className='h-screen w-full'>
      <div data-scroll data-scroll-section data-scroll-speed="-0.3" className='h-screen w-full bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")] bg-cover bg-center relative'>
