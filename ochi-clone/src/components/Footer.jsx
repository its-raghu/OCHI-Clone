  ...
  return (
    <div className='w-full h-screen px-16'>
      <div className='flex gap-5'>
        <div className='w-1/2 h-full flex flex-col justify-between py-14'>
            <h1 className='uppercase text-[9vw] font-Grotesk leading-[7vw]'>eye-<br/>opening</h1>
        </div>
        <div className='w-1/2 h-full'>
          <h1 className='font-Grotesk text-[9vw] uppercase'>presentations</h1>
          <div className='grid grid-cols-2 grid-rows-2 font-Neue'>
            <div className='col-span-2'>
              <p className='text-xl pb-4'>S:</p>
              {["Instagram","Behance","Facebook","Linkedin"].map((items,index)=>{
                return(
                  <a href="" className='flex text-xl pt-[2px] font-Neue underline underline-offset-4 decoration-1'>{items}</a>
                )
              })}
            </div>
            <div className='-mt-3'>
              <p className='text-xl pb-4'>L:</p>
              <div className='pb-10'>
                {["202-1965 W 4th Ave","Vancouver, Canada"].map((items,index)=>{
                  return(
                    <a href="" className='flex text-xl pt-[2px] underline underline-offset-4 decoration-1'>{items}</a>
                  )
                })}
              </div>
              <div>
      ...
      <div className='w-full pt-16 flex'>
        ...
        <div className='flex text-xl w-1/2 opacity-30 justify-between'>
          <p>&copy; ochi design 2024. <a href="" className='pt-[2px] underline underline-offset-4 decoration-1'>Legal Terms</a></p>
          <p>Website by Obsy</p>
        </div>
      </div>
    </div>
